...
This directory contains automated CI/CD workflows for the Fox Finance monorepo. All workflows are based on the comprehensive CI/CD guide at [`apps/infra/CI_CD.md`](../../apps/infra/CI_CD.md).
...
- Dev: `https://api.dev.fox-finance.net/health`
- Prod: `https://api.fox-finance.net/health`
...
- Prod: `https://storybook.fox-finance.net`
