...
export interface StaticSiteProps {
  ...
  /**
   * Domain name for the site (e.g., app.fox-finance.net, storybook.fox-finance.net)
   */
  domainName: string;

  /**
   * Hosted zone name (e.g., fox-finance.net)
   */
...
export class StaticSite extends Construct {
  ...
  /**
   * The full website URL (e.g., https://app.fox-finance.net)
   */
  ...
  constructor(scope: Construct, id: string, props: StaticSiteProps) {
    ...
    this.bucket = new s3.Bucket(this, "Bucket", {
      bucketName: `${environmentName}-${siteName}-fox-finance-io`,
