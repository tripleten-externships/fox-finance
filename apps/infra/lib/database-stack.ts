...
export class DatabaseStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: DatabaseStackProps) {
    ...
    new ssm.StringParameter(this, "DbEndpointParameter", {
      parameterName: `/fox-finance/${config.name}/database/endpoint`,
    ...
    new ssm.StringParameter(this, "DbPortParameter", {
      parameterName: `/fox-finance/${config.name}/database/port`,
    ...
    new ssm.StringParameter(this, "DbNameParameter", {
      parameterName: `/fox-finance/${config.name}/database/name`,
    ...
    new ssm.StringParameter(this, "DbConnectionStringParameter", {
      parameterName: `/fox-finance/${config.name}/database/connection-string-template`,
