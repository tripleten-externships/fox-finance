/**
 * Environment Configuration for Fox Finance Infrastructure
 *
...
export const devConfig: EnvironmentConfig = {
  ...
  // Domains
  domain: "dev.fox-finance.net",
  apiDomain: "api.dev.fox-finance.net",
  storybookDomain: "storybook.dev.fox-finance.net",
  hostedZoneName: "fox-finance.net",
...
export const prodConfig: EnvironmentConfig = {
  ...
  // Domains
  domain: "app.fox-finance.net",
  apiDomain: "api.fox-finance.net",
  storybookDomain: "storybook.fox-finance.net",
  hostedZoneName: "fox-finance.net",
